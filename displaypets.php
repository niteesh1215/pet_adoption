...
$query="SELECT ad_id,pet_name,gender FROM ad_info";
           ...
           <?php 
            while($rows=mysqli_fetch_array($result))
            {
                ...
                echo '<div class="name_favorite_align">'.
                        ...
                        switch($rows['gender'])
                        {
                            case -1: echo '<p style="color: yellow; padding-right: 8px; font-size: 30px;text-align: center; margin: 0;">N.K.</p>';break;
                            case 0: echo '<p style="color: #02b2fb; padding-right: 8px; font-size: 30px;text-align: center; margin: 0;">M</p>';break;
                            case 1: echo '<p style="color: #ed2ccb; padding-right: 8px; font-size: 30px;text-align: center; margin: 0;">F</p>';break;
                        }
